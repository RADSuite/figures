...
To run a file in RStudio, open the file using the menu at the top of the IDE and then use the "Source" button in the top right corner of the file window in RStudio.
