...
Now figure 2 can be generated by first running the rscript "access_data.r" and then "create_figure_2.r". Both of the files needed for creating figure 2 can be found in the figure-2 directory.
